...
import { pgTable, text, timestamp, boolean, index, pgEnum, uniqueIndex, integer, numeric, jsonb, } from "drizzle-orm/pg-core";
...
export const customisations = pgTable("customisations", {
    ...
    uniqueIndex("customisations_unique_template_per_store_idx").on(table.storeId, table.template),
]);
...
export const productWheelSettingsRelations = relations(productWheelSettings, ({ one }) => ({
...
export const category = pgTable("category", {
    ...
    uniqueIndex("product_category_name_store_profile_id_idx").on(table.name, table.storeId),
...
export const productWeight = pgTable("product_weight", {
    id: text("id")
        .primaryKey()
        .$defaultFn(() => crypto.randomUUID()),
...
export const color = pgTable("color", {
    ...
    uniqueIndex("color_name_store_profile_id_idx").on(table.name, table.storeId),
...
export const productVariant = pgTable("product_variant", {
    ...
    uniqueIndex("product_variant_unique_combination_idx").on(table.productId, table.colorId, table.sizeId),
]);
...
export const productSource = pgTable("product_source", {
    ...
    uniqueIndex("product_source_name_store_profile_id_idx").on(table.name, table.storeId),
    // Ensure unique combination of slug and store profile
    uniqueIndex("product_source_slug_store_profile_id_idx").on(table.slug, table.storeId),
...
export const customerSesssionRelations = relations(customerSesssion, ({ one }) => ({
...
export const shippingZone = pgTable("shipping_zone", {
    ...
    uniqueIndex("shipping_zone_location_idx").on(table.storeId, table.country, table.state, table.area),
...
export const shippingCondition = pgTable("shipping_condition", {
    id: text("id")
        .primaryKey()
        .$defaultFn(() => crypto.randomUUID()),
...
export const shippingZoneRelations = relations(shippingZone, ({ one, many }) => ({
    store: one(store, {
...
export const shippingConditionRelations = relations(shippingCondition, ({ one }) => ({
...
// -------------------------------------------------------
export const customerSavedProduct = pgTable("customer_saved_product", {
    id: text("id")
        .primaryKey()
        .$defaultFn(() => crypto.randomUUID()),
    customerId: text("customer_id")
    ...
    uniqueIndex("customer_saved_product_unique_idx").on(table.customerId, table.productId),
...
export const customerSavedProductRelations = relations(customerSavedProduct, ({ one }) => ({
    customer: one(customer, {
...
// -------------------------------------------------------
export const customerSavedAddress = pgTable("customer_saved_address", {
    id: text("id")
        .primaryKey()
        .$defaultFn(() => crypto.randomUUID()),
    customerId: text("customer_id")
    ...
    index("customer_saved_address_default_idx").on(table.customerId, table.isDefault),
]);
export const customerSavedAddressRelations = relations(customerSavedAddress, ({ one }) => ({
    customer: one(customer, {
...
export const order = pgTable("order", {
    ...
    index("order_store_payment_ref_idx").on(table.storeId, table.paymentReference),
...
// -------------------------------------------------------
export const storeVisit = pgTable("store_visit", {
    id: text("id")
        .primaryKey()
        .$defaultFn(() => crypto.randomUUID()),
    storeId: text("store_id")
...
export const featureLimits = pgTable("feature_limits", {
    ...
    uniqueIndex("feature_limits_plan_feature_idx").on(table.planType, table.featureKey),
...
export const featureUsage = pgTable("feature_usage", {
    ...
    uniqueIndex("feature_usage_user_feature_idx").on(table.userId, table.featureKey),
...
export const featureOverrides = pgTable("feature_overrides", {
    ...
    uniqueIndex("feature_overrides_user_feature_idx").on(table.userId, table.featureKey),
...
export const featureOverridesRelations = relations(featureOverrides, ({ one }) => ({
    user: one(user, {
