...
export default function Account({ user, currentSession, }) {
    ...
    const handleChangePassword = async (values) => {
        ...
        try {
            ...
            toast("Password changed", {
                description: "Your password has been changed successfully. All other sessions have been revoked.",
            });
            fetchSessions();
        }
        catch (error) {
    ...
    return (<div className="container max-w-5xl py-10 mx-auto">
            ...
            <form onSubmit={handleUpdateProfile}>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input id="name" value={profileForm.name} onChange={(e) => setProfileForm({ ...profileForm, name: e.target.value })} placeholder="Your full name"/>
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="image" value={profileForm.image} onChange={(e) => setProfileForm({ ...profileForm, image: e.target.value })} placeholder="https://example.com/avatar.jpg"/>
                </div>
                <div className="space-y-2">
              ...
              <form onSubmit={passwordForm.handleSubmit(handleChangePassword)}>
                  ...
                  <FormField control={passwordForm.control} name="currentPassword" render={({ field }) => (<FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input {...field} type={showCurrentPassword ? "text" : "password"} disabled={loading.password}/>
                ...
                : "Show password"}
                  ...
                  <FormField control={passwordForm.control} name="newPassword" render={({ field }) => (<FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input {...field} type={showNewPassword ? "text" : "password"} disabled={loading.password}/>
                ...
                : "Show password"}
                  ...
                  <FormField control={passwordForm.control} name="confirmPassword" render={({ field }) => (<FormItem>
                        ...
                        <FormControl>
                          <div className="relative">
                            <Input {...field} type={showConfirmPassword ? "text" : "password"} disabled={loading.password}/>
        ...
        <TabsContent value="sessions" className="mt-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Button variant="outline" onClick={handleRevokeAllSessions} disabled={!sessions || sessions.length <= 1}>
                <LogOut className="mr-2 h-4 w-4"/>
                Sign Out All Devices
              </Button>
            </CardHeader>
            <CardContent>
              {loading.sessions ? (<div className="flex justify-center py-8">
                  <div className="animate-pulse text-center">
                    <p className="text-sm text-muted-foreground">
                      Loading sessions...
                    </p>
                  </div>
                </div>) : !sessions || sessions.length === 0 ? (<div className="py-8 text-center">
                  <p className="text-sm text-muted-foreground">
                    No active sessions found
                  </p>
                </div>) : (<div className="space-y-4">
                  {sessions.map((session) => (<div key={session.id} className="rounded-lg border p-4">
                      <div className="flex items-start justify-between">
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {isCurrentSession(session) && (<Badge variant="secondary" className="text-xs">
                                Current
                              </Badge>)}
                          </div>
                        ...
                        <Button variant="ghost" size="sm" onClick={() => handleRevokeSession(session.token)} disabled={isCurrentSession(session)}>
