    ...
    return (<>
      ...
      <div className="max-w-7xl xl:mx-auto mt-20">
        ...
        {useProductWheel && (<section className="py-8">
            ...
            <ProductWheel storeId={store.id} circleTime={store.customisations[0].productWheelSettings.circleTime || 3} productCount={store.customisations[0].productWheelSettings.productCount || 6} categoryId={store.customisations[0].productWheelSettings.categoryId || "all"}/>
          </section>)}
          ...
          <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:items-center md:justify-between mb-8">
            <div className="flex items-center space-x-2">
              ...
              <div className="hidden md:flex border rounded-md">
                <Button variant={viewMode === "grid" ? "default" : "ghost"} size="icon" className="rounded-none rounded-l-md" onClick={() => setViewMode("grid")}>
                  <Grid3X3 className="h-4 w-4"/>
                </Button>
                <Separator orientation="vertical"/>
                <Button variant={viewMode === "list" ? "default" : "ghost"} size="icon" className="rounded-none rounded-r-md" onClick={() => setViewMode("list")}>
