...
import { ArrowRight, ArrowUpRight, Instagram, Mail, Check, Zap, Crown, Rocket, Store, Code, Palette, Package, CreditCard, Users, Globe, Search, BarChart3, Smartphone, Shield, } from "lucide-react";
        ...
        items: [
            {
                ...
                description: "Get a custom website link (yourstore.zynkart.store) to share on WhatsApp, Instagram, and Twitter. Look like a serious business.",
            },
            {
                icon: Globe,
                title: "No More 'DM for Price'",
                description: "Your customers see clear prices and can order directly. No more replying to 100 DMs asking the same questions.",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                description: "Add products with photos, prices, sizes, and colors. Track what's in stock automatically, no Excel sheets needed.",
            },
            {
                icon: Palette,
                title: "Beautiful Ready-Made Designs",
                description: "Pick from professional templates that make your products look premium. Just add your items and go live.",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                description: "Accept payments via Paystack, Flutterwave, and bank transfers. Customers pay in Naira, money goes straight to your account.",
            },
            {
                icon: Mail,
        ...
        items: [
            {
                ...
                description: "Customers can create accounts, save addresses, and view order history. They'll keep coming back.",
            },
            {
                icon: Search,
                title: "People Can Find You on Google",
                description: "Your store is built to rank on Google. New customers can discover you beyond just social media.",
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                description: "See your best products, busiest days, and customer behavior. Make smarter decisions with real data.",
            },
            {
                icon: Smartphone,
        ...
        items: [
            {
                ...
                description: "Bank-level security protects every transaction. Your customers can trust buying from you.",
            },
            {
                icon: Code,
                title: "Always Available",
                description: "Your store never sleeps. Customers can browse and order 24/7, even while you're in class or asleep.",
            },
        ],
    },
];
...
const PLANS = [
    ...
    },
    {
        ...
        price: 100000,
        period: "per month",
        description: "For established businesses with multiple brands or high volume.",
        featured: false,
        features: [
            "Unlimited stores",
            "Unlimited products",
...
const Hero = () => {
    ...
    return (<section className="relative h-screen w-full overflow-hidden bg-zinc-100 dark:bg-zinc-900 flex items-center justify-center border-b border-zinc-200 dark:border-zinc-800">
      <motion.div style={{
        ...
        <div className="w-full h-full bg-cover bg-center grayscale opacity-20" style={{
    ...
    return (<section id="features" className="py-32 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {FEATURE_GROUPS.map((group) => (<div key={group.id} className="group relative overflow-hidden flex h-full flex-col justify-between border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-8 py-10 transition-all duration-500 hover:border-zinc-900 dark:hover:border-zinc-100">
              ...
              <div className="relative z-10 w-full h-full flex flex-col justify-between">
                ...
                return (<div key={item.title} className="flex items-start gap-5 group/item cursor-default">
                          <div className="mt-0.5 flex h-12 w-12 shrink-0 items-center justify-center border border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 group-hover/item:bg-zinc-900 group-hover/item:border-zinc-900 dark:group-hover/item:bg-zinc-100 dark:group-hover/item:border-zinc-100 transition-colors duration-500">
                            <Icon size={18} className="text-zinc-900 dark:text-zinc-100 group-hover/item:text-white dark:group-hover/item:text-zinc-900 transition-colors duration-500"/>
                          </div>
                          <div>
        ...
        <div className="mt-32 flex justify-center">
          <button className="group relative flex items-center gap-3 text-sm uppercase tracking-widest font-medium text-zinc-900 dark:text-zinc-100 pb-2 overflow-hidden">
            ...
            <div className="relative z-10 overflow-hidden w-4 h-4">
              <ArrowRight size={16} className="absolute transition-transform duration-300 group-hover:translate-x-full"/>
              <ArrowRight size={16} className="absolute -translate-x-full transition-transform duration-300 group-hover:translate-x-0"/>
            </div>
...
const Pricing = () => {
    return (<section id="pricing" className="py-32 bg-zinc-100 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 border-t border-zinc-200 dark:border-zinc-800">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          {PLANS.map((plan) => {
            ...
            return (<div key={plan.name} className={`border border-zinc-200 dark:border-zinc-800 p-10 flex flex-col ${plan.featured ? "bg-white dark:bg-zinc-900 shadow-[0_40px_80px_rgba(0,0,0,0.25)]" : "bg-transparent"}`}>
                ...
                <button className={`w-full text-xs uppercase tracking-widest border px-6 py-3 transition-colors ${plan.featured ? "border-zinc-900 dark:border-zinc-100 text-white bg-zinc-900 dark:bg-zinc-100 dark:text-black" : "border-zinc-300 dark:border-zinc-700 hover:border-zinc-900 dark:hover:border-zinc-100"}`}>
                  {plan.name === "Starter"
                    ? "Start Free"
                    : `Choose ${plan.name}`}
                </button>
                ...
                <div className="mt-10">
                  ...
                  <ul className="flex flex-col gap-3">
                    {plan.features.map((feature) => (<li key={feature} className="flex items-start gap-3 text-sm text-zinc-600 dark:text-zinc-400">
                ...
                <div className="mt-8 border-t border-zinc-200 dark:border-zinc-800 pt-6">
                  ...
                  <ul className="flex flex-col gap-3">
                    {plan.limitations.map((item) => (<li key={item} className="flex items-start gap-3 text-sm text-zinc-500">
...
const Philosophy = () => {
    return (<section id="how-it-works" className="py-32 bg-zinc-100 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div>
                <div className="aspect-[4/3] w-full overflow-hidden bg-zinc-200 dark:bg-zinc-900">
                  <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=1600&auto=format&fit=crop" alt="Seller creating an online store dashboard" className="h-full w-full object-cover"/>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div>
                <div className="aspect-[4/3] w-full overflow-hidden bg-zinc-200 dark:bg-zinc-900">
                  <img src="https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?q=80&w=1600&auto=format&fit=crop" alt="Product grid on a laptop screen" className="h-full w-full object-cover"/>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              <div>
                ...
                <p className="text-sm md:text-base leading-relaxed text-zinc-600 dark:text-zinc-400">
                  ...
                  <a href="https://paystack.com" target="_blank" rel="noreferrer" className="underline hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
                    Paystack
                  </a>{" "}
                  or{" "}
                  <a href="https://flutterwave.com" target="_blank" rel="noreferrer" className="underline hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors">
                    Flutterwave
                  </a>
              ...
              <div>
                <div className="aspect-[4/3] w-full overflow-hidden bg-zinc-200 dark:bg-zinc-900">
                  <img src="https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=1600&auto=format&fit=crop" alt="Customer shopping online with a phone and card" className="h-full w-full object-cover"/>
                </div>
              </div>
            </div>
...
const FAQ = () => {
    ...
    return (<section id="faq" className="py-32 bg-zinc-100 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 border-t border-zinc-200 dark:border-zinc-800">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:justify-between md:items-end mb-20 border-b border-zinc-200 dark:border-zinc-800 pb-6 gap-6">
          <div>
            <span className="text-xs uppercase tracking-widest text-zinc-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
          {faqs.map((faq, index) => (<div key={index} className="flex flex-col border-t border-zinc-200 dark:border-zinc-800 pt-6">
              ...
              {faq.link && (<Link href={faq.link.url} className="mt-auto group inline-flex items-center gap-2 text-xs uppercase tracking-widest text-zinc-900 dark:text-zinc-100 font-medium hover:text-zinc-500 transition-colors">
                  {faq.link.text}
...
const Journal = () => {
    return (<section id="stories" className="py-32 bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 border-t border-zinc-200 dark:border-zinc-800">
      <div className="container mx-auto px-6">
      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-32">
          <div className="flex flex-col gap-8">
            ...
            <a href="mailto:hello@zynkart.store" className="flex items-center gap-3 text-zinc-400 hover:text-white transition-colors text-lg">
              <Mail size={20}/>
              hello@zynkart.store
            </a>
          </div>
